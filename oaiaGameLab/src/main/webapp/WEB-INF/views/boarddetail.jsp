		...
		<div class="wrapper">
			...
			<div class="insertBtn">
				<div class="boardInsertBtn">
					<a href="update?idx=${idx}&user_nickname='${user_nickname}'">수정하기</a>
					<a href="delete?user_nickname='${user_nickname}'&idx=${idx}">삭제하기</a>
				</div>
			</div>
		</div>
		<div class="content">
						...
						<tbody>
							...
							<tr class="nickname">
								<td><span type="text" name="user_nickname"
									value="${user_nickname}"><i class="fas fa-ghost">
											${user_nickname}</span></td>
							</tr>
							<tr class="created">
			...
			<div class="comments">
				...
				<form action="boardComments_action" method="POST" class="totalForm">
					...
					<input type="hidden" name="idx" value="${idx}">
						<span type="text" name="user_nickname" ">
